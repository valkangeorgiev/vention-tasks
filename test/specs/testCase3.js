...
describe('Test case 3', () => {
    it('Check error message, username and password fields contains error icons,', async () => {
        ...
        Logger.logSteps(2,'Click the Login Button.')
        await loginPage.clickLoginButton();

        Logger.logSteps(3,'Check if error message is displayed.');
        ...
        Logger.logSteps(4,'Check if username error icon is displayed');
        ...
        Logger.logSteps(5,'Check if password error icon is displayed.');
        ...
        Logger.logSteps(6,'Click the error message close button.');
        await errorMessage.clickErrorMessageCloseButton();

        Logger.logSteps(7,'Wait unit error message, error username icon and error password icon are not displayed anymore.');
